...
init -20 python:
        ...
        def yc_generate_vertical_house_world():
                ...
                # Ground floor zones with real cells on the current 2D grid.
                room.define_zone(10, name="living_room_0", zone_type="room", level_id=0, tags=["house", "ground", "living"])
                room.define_zone(11, name="hall_0",        zone_type="hall", level_id=0, tags=["house", "ground", "hall"])
                room.define_zone(12, name="kitchen_0",     zone_type="room", level_id=0, tags=["house", "ground", "kitchen"])
                room.define_zone(20, name="stairwell_0",   zone_type="stairwell", level_id=0, tags=["house", "ground", "vertical", "stairs"])

                # Upper floor zones are metadata-first for now.
                upper_footprint = [(6, 1), (7, 1), (8, 1), (6, 2), (7, 2), (8, 2), (6, 3), (7, 3), (8, 3)]
                room.define_zone(110, name="hall_1",      zone_type="hall", level_id=1, tags=["house", "upper", "hall"], meta={"footprint_cells": upper_footprint})
                room.define_zone(111, name="bedroom_a_1", zone_type="room", level_id=1, tags=["house", "upper", "bedroom"], meta={"footprint_cells": [(1, 1), (2, 1), (3, 1)]})
                room.define_zone(112, name="bedroom_b_1", zone_type="room", level_id=1, tags=["house", "upper", "bedroom"], meta={"footprint_cells": [(11, 1), (12, 1), (13, 1)]})
                room.define_zone(120, name="stairwell_1", zone_type="stairwell", level_id=1, tags=["house", "upper", "vertical", "stairs"], meta={"footprint_cells": upper_footprint})
        ...
        def yc_vertical_house_summary(world=None):
                try:
                        ...
                        return "Vertical house: levels=%s links=%s openings=%s portals=%s vertical_ok=%s" % (
                                levels_n,
                                links_n,
                                openings_n,
                                portals_n,
